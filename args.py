...
class SNNArgs(argparse.Namespace):
    def __init__(self, **kwargs: Any) -> None:
        ...
        # training details
        self.mode = "train"  # ['train', 'conversion', 'distill']
        self.model_mode = "combine"   # ['snn', 'ann', 'combine']
        self.model_type = 'cnn_snn'  # ["textcnn", "lstm", "dpcnn", "cnn_snn"]
        ...
        self.workspace = '/root/paddlejob/workspace/env_run/yangwanli01/snn'
        ...
        self.pretrained_snn_lstm_path = "./saved_models/best_snn_lstm.pth"
        self.pretrained_cnn_path = "./saved_models/best_cnn.pth"
    ...
    def renew_args(self):
        ...
        elif self.model_mode == "combine" and self.mode == "train":
            self.args_for_logging = ["model_mode", "mode", "model_type", "dataset_name",  "positive_init_rate", "num_steps", "sentence_length", "dropout_p", "weight_decay", "batch_size", "learning_rate", "label_num"]
        self.data_dir = os.path.join(self.workspace, "data", self.dataset_name)
        self.logging_dir = os.path.join(self.workspace, 'logs')
        self.saving_dir = os.path.join(self.workspace, "saved_models")
        self.vocab_path = os.path.join(self.workspace, f"data/glove.6B.{self.hidden_dim}d.txt")
